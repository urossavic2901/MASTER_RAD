...
# Dataset
data_dir = "/content/drive/MyDrive/SWIMCAT/dataset_split/train"
filepaths = []
labels = []
...
# Model funkcija
def create_model(trainable_layers=0, lr=5e-4):
    base_model = EfficientNetB0(weights='imagenet', include_top=False, input_shape=input_shape)
    # Zamrzni slojeve osim poslednjih trainable_layers
...
for train_idx, val_idx in kf.split(df):
    ...
    # STAGE 2 fine-tuning poslednjih 10 slojeva
    model = create_model(trainable_layers=10, lr=1e-5)
